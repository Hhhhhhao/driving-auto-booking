...
if __name__ == '__main__':
	...
	coachName = str(input("请输入教练名称："))
	date = str(input("请输入预约日期(yy-mm-dd)："))

	# start_time_list = ['08:00', '09:00']
	start_time_list = ['07:00','08:00', '09:00', '16:00', '17:00', '18:00', '19:00']
	backup_time_list = ['10:00', '11:00', '12:00', '13:00', '14:00', '15:00']
	
	# parse json
	print("获取预约计划中......")
	while True:
		json_planning_list = ds.get_planning_list(schoolName, coachName, date)
		available_ids = parse_json(json_planning_list, start_time_list)
